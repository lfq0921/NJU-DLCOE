...
HD_PWD='D:/CS/lab/lab06/lab06.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lfsr_seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lfsr_seg.tcl -notrace
