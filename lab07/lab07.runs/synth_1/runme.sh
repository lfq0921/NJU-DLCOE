...
HD_PWD='D:/CS/lab/lab07/lab07.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log keyboard_b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source keyboard_b.tcl
