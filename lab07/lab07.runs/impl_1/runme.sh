...
HD_PWD='D:/CS/lab/lab07/lab07.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log keyboard_b.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source keyboard_b.tcl -notrace
