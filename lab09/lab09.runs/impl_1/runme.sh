...
HD_PWD='D:/CS/lab/lab09/lab09.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab09_ctrl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab09_ctrl.tcl -notrace
